...
//
const AddUser = React.lazy(() => import('./views/formmanagement/create-user/CreateUser'));
const ListUsers = React.lazy(() => import('./views/formmanagement/list-user/Users'));
const FormTransform = React.lazy(() => import('./views/formmanagement/list-user/FormTransform'));
const UsersPage = React.lazy(() => import('./views/formmanagement/list-user/UsersPage'));
...
const routes = [
  ...
  { path: '/formmanagement/formdynamic', name: 'Form Dynamic', component: AddUser },
  { path: '/formmanagement/listform', name: 'List Form Data', component: ListUsers },
  { path: '/formmanagement/formtransform', name: 'List Form Data', component: FormTransform },
  { path: '/formmanagement/listuserpage/:page', name: 'List User Details', component: UsersPage },
